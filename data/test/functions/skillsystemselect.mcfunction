...
#加速 ディスプレイ表示
execute as @e[tag=skillselect,scores={skillselect=1}] at @s positioned ~ ~3 ~ unless entity @e[distance=..3,type=item_display] run summon item_display ~ ~ ~ {item:{id:"minecraft:blue_dye",Count:1b},Tags:[skillselectitem,nowdisplay],teleport_duration:100}
...
#浮遊 ディスプレイ表示
execute as @e[tag=skillselect,scores={skillselect=2}] at @s positioned ~ ~3 ~ unless entity @e[distance=..3,type=item_display] run summon item_display ~ ~ ~ {item:{id:"minecraft:light_gray_dye",Count:1b},Tags:[skillselectitem,nowdisplay],teleport_duration:100}
...
#透明化 ディスプレイ表示
execute as @e[tag=skillselect,scores={skillselect=3}] at @s positioned ~ ~3 ~ unless entity @e[distance=..3,type=item_display] run summon item_display ~ ~ ~ {item:{id:"minecraft:white_dye",Count:1b},Tags:[skillselectitem,nowdisplay],teleport_duration:100}
...
execute as @e[tag=skillselect,scores={skillselect=4}] at @s positioned ~ ~3 ~ unless entity @e[distance=..3,type=item_display] run summon item_display ~ ~ ~ {item:{id:"minecraft:yellow_dye",Count:1b},Tags:[skillselectitem,nowdisplay],teleport_duration:100}
...
execute as @e[tag=skillselect,scores={skillselect=5}] at @s positioned ~ ~3 ~ unless entity @e[distance=..3,type=item_display] run summon item_display ~ ~ ~ {item:{id:"minecraft:red_dye",Count:1b},Tags:[skillselectitem,nowdisplay],teleport_duration:100}
...
execute as @e[tag=skillselect,scores={skillselect=6}] at @s positioned ~ ~3 ~ unless entity @e[distance=..3,type=item_display] run summon item_display ~ ~ ~ {item:{id:"minecraft:orange_dye",Count:1b},Tags:[skillselectitem,nowdisplay],teleport_duration:100}
...
execute as @e[tag=skillselect,scores={skillselect=7}] at @s positioned ~ ~3 ~ unless entity @e[distance=..3,type=item_display] run summon item_display ~ ~ ~ {item:{id:"minecraft:lime_dye",Count:1b},Tags:[skillselectitem,nowdisplay],teleport_duration:100}
...
execute as @e[tag=skillselect,scores={skillselect=8}] at @s positioned ~ ~3 ~ unless entity @e[distance=..3,type=item_display] run summon item_display ~ ~ ~ {item:{id:"minecraft:cyan_dye",Count:1b},Tags:[skillselectitem,nowdisplay],teleport_duration:100}
