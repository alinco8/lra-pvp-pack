...
give @s minecraft:splash_potion[custom_data={stan_grenade:1b},item_model=stan_grenade] 16
give @s minecraft:snowball[custom_data={smoke_grenade:1b},item_model=grenade] 64
